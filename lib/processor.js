...
module.exports = {
     ...
     *
     */
    process : function (name, type, data) {
        ...
        if (Object.prototype.toString.call(data) === '[object Object]') {
            ...
            if (currentIds !== false) {
                ...
                this.getStreamHash(this.getCsdl('[' + currentIds + ']'), function (err, res) {
                    ...
                    logger.info('Saving new hash ' + type + ': ' + dataSiftResponse.hash);
                    self.setHash(dataSiftResponse.hash);
                    utils.saveFile(name + '-' + type + '.csdl', "\n\n" + moment().format('MMMM Do YYYY, h:mm:ss a') + ":\n" + self.getHashString());
                    logger.info('Final CSDL ' + type + ':', self.getHashString());
                    //clear hasharray from next use
                    hashArray = []
                });
            }
        }
